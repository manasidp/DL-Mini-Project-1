...
def main():
    ...
    try:
        ...
        model.load_state_dict(torch.load('./project1_model.pt', map_location=device)['net'], strict=False)
    
#         torch.save(model.module.state_dict(), './project1_model_new.pt')
#         print("Saved")
#         model_new = load_model(device)
        criterion = nn.CrossEntropyLoss()
#         model_new.load_state_dict(torch.load('./project1_model.pt', map_location=device), strict=False)
